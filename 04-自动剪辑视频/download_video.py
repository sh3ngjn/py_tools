...
url = "https://www.pexels.com/zh-cn/search/videos/ocean/?size=large&orientation=landscape"
video_links = []
audio_url = ""
...
def download_video_series(video_links):
   ...
   # iterate through all links in video_links
    ...
    #obtain filename by splitting url and getting last string
        ...
        #download started
        with open("/Users/shengjun/Nutstore Files/01-个人发展/02-程序相关/01-自动脚本/Youtube-Shorts-Bot/download_video"+file_name, 'wb') as f:
